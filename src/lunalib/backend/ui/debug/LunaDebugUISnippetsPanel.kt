...
class LunaDebugUISnippetsPanel : LunaDebugUIInterface {
    ...
    var snippets: MutableList<lunalib.lunaDebug.LunaSnippet> = ArrayList()
    ...
    companion object
    {
        ...
        var filters = mutableListOf("All", lunalib.lunaDebug.LunaSnippet.SnippetTags.Cheat.toString(), lunalib.lunaDebug.LunaSnippet.SnippetTags.Debug.toString(),
            lunalib.lunaDebug.LunaSnippet.SnippetTags.Cargo.toString(),
            lunalib.lunaDebug.LunaSnippet.SnippetTags.Entity.toString(),
            lunalib.lunaDebug.LunaSnippet.SnippetTags.Player.toString(),
            lunalib.lunaDebug.LunaSnippet.SnippetTags.Faction.toString())
    ...
    override fun init(parentPanel: CustomPanelAPI, parentClass: LunaDebugUIMainPanel, panel: CustomPanelAPI) {
        ...
        filters.clear()
        filters = mutableListOf("All", lunalib.lunaDebug.LunaSnippet.SnippetTags.Cheat.toString(), lunalib.lunaDebug.LunaSnippet.SnippetTags.Debug.toString(),
            lunalib.lunaDebug.LunaSnippet.SnippetTags.Cargo.toString(),
            lunalib.lunaDebug.LunaSnippet.SnippetTags.Entity.toString(),
            lunalib.lunaDebug.LunaSnippet.SnippetTags.Player.toString(),
            lunalib.lunaDebug.LunaSnippet.SnippetTags.Faction.toString())
       ...
       // searchField.uiElement.addComponent(pan)
        ...
        for (filter in filters)
        {
            var button = LunaUIButton(false, false, 250f, 30f, filter, "Debug", panel!!, tagScroller!!).apply {
                ...
                {
                    lunalib.lunaDebug.LunaSnippet.SnippetTags.Cheat.toString() -> "Snippets that generaly allow you to alter values."
                    lunalib.lunaDebug.LunaSnippet.SnippetTags.Debug.toString() -> "Snippets for debugging the game to make finding issues and other kinds of data easier."
                    lunalib.lunaDebug.LunaSnippet.SnippetTags.Cargo.toString() -> "Snippets for interacting with Cargo/Inventory."
                    lunalib.lunaDebug.LunaSnippet.SnippetTags.Entity.toString() -> "Snippets for interacting with Campaign Entities, i.e Fleets, Planets, Stations, etc"
                    lunalib.lunaDebug.LunaSnippet.SnippetTags.Player.toString() -> "Snippets for interactions regarding the player."
                    lunalib.lunaDebug.LunaSnippet.SnippetTags.Faction.toString() -> "Snippets for interacting with a Faction."
                    else -> ""
                }

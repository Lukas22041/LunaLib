...
class LunaUISprite(var spritePath: String, var maxX: Float, var maxY: Float, minX: Float, minY: Float, width: Float, height: Float, key: Any, group: String, panel: CustomPanelAPI, uiElement: TooltipMakerAPI) : lunalib.backend.ui.components.base.LunaUIBaseElement(width, height, key, group, panel, uiElement) {

...
class RefitButtonAdder : EveryFrameScript {
    ...
    var activePanelButton: lunalib.lunaRefit.BaseRefitButton? = null
    ...
    override fun advance(amount: Float) {
        ...
        if (base != null)
        {
            ...
            var openButton = openButtonElement.addLunaSpriteElement("graphics/ui/lunaRefitButtonMain.png", _root_ide_package_.lunalib.lunaUI.elements.LunaSpriteElement.ScalingTypes.STRETCH_SPRITE, buttonWidth, 20f).apply {
    ...
    fun recreateBackgroundPanel() {
        ...
        var closeButton = closeButtonElement.addLunaSpriteElement("graphics/ui/lunaRefitButtonMain.png", _root_ide_package_.lunalib.lunaUI.elements.LunaSpriteElement.ScalingTypes.STRETCH_SPRITE, mainPanel!!.position.width, 20f).apply {
            getSprite().color = Misc.getDarkPlayerColor().setAlpha(255)
            innerElement.bringComponentToTop(innerElement.prev)
        ...
        for (button in LunaRefitManager.buttons.sortedBy {it.getOrder(member, variant)})
        {
            ...
            var sprite = buttonElement.addLunaSpriteElement(button.getIconName(member, variant), _root_ide_package_.lunalib.lunaUI.elements.LunaSpriteElement.ScalingTypes.STRETCH_SPRITE, 0f, 0f).apply {

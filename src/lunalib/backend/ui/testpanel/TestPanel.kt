...
class TestPanel : LunaBaseCustomPanelPlugin() {
    ...
    override fun init() {
        ...
        newElement.addSpacer(10f)
        newElement.addLunaSpriteElement(Global.getSettings().allShipHullSpecs.random().spriteName,
            _root_ide_package_.lunalib.lunaUI.elements.LunaSpriteElement.ScalingTypes.STRETCH_ELEMENT,200f,200f).apply {

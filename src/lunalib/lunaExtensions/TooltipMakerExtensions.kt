...
fun TooltipMakerAPI.addLunaSpriteElement(spritePath: String, scaling: _root_ide_package_.lunalib.lunaUI.elements.LunaSpriteElement.ScalingTypes, width: Float, height: Float) : _root_ide_package_.lunalib.lunaUI.elements.LunaSpriteElement
{
    var element = _root_ide_package_.lunalib.lunaUI.elements.LunaSpriteElement(spritePath, scaling, this, width, height)
    return element
}
